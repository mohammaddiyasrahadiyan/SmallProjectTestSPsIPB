...
<div class="container-fluid">
	...
	<!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Form Update Transkrip</h1>
    ...
    <?php echo form_open(); ?>
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="nim" id="nim">
                <option value="<?php echo $dataTaranskrip['nim'] ?>">
                <?php echo $dataTaranskrip['nim'] . " | " . $dataTaranskrip['nama_mahasiswa']; ?></option>
                <option value="">---</option>
                <?php
                ...
                <?php echo $data['nim'] . " | " . $data['nama_mahasiswa'] ?></option>
                <?php } ?>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="semester" id="semester">
                <option value="<?php echo $dataTaranskrip['semester'] ?>">
                <?php echo $dataTaranskrip['semester'] ?></option>
                <option value="">---</option>
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="kode_matakuliah" id="kode_matakuliah">
                <option value="<?php echo $dataTaranskrip['kode_matakuliah'] ?>">
                <?php echo $dataTaranskrip['kode_matakuliah'] . " | " . $dataTaranskrip['nama_matakuliah'] ?></option>
                <option value="">---</option>
                <?php
                $conn = mysqli_connect("localhost", "root", "");
                        mysqli_select_db($conn, "db_kampus");
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="mutu_matakuliah" id="mutu_matakuliah">
                <option value="<?php echo $dataTaranskrip['mutu_matakuliah'] ?>">
                <?php echo $dataTaranskrip['mutu_matakuliah'] ?></option>
                <option value="">---</option>
